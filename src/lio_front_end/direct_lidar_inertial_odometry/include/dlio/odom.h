...
class dlio::OdomNode {
 ...
 private:
  ...
  ros::Publisher perception_odom_pub;
  ros::Publisher perception_cloud_pub;
  ...
  double crop_length_size_;
  double crop_width_size_;
  double crop_height_size_;
