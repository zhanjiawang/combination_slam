...
public: 
    ...
    std::pair<double, float> compareCurrentAndIndexed (int candidate_index);
    ...
    // for save and read
    bool savePolarContexts(const std::string& filename);
    bool loadPolarContexts(const std::string& filename);
